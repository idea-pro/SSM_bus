    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                fit: true,//自动大小
                method: "post",
                url: "getZoneList?t" + new Date().getTime(),
                idField: 'id',
                ...
                columns: [[
                    ...
                    {field: 'name', title: '片区名称', width: 150},
                    {field: 'manager', title: '片区负责人', width: 150},
                    {field: 'email', title: '负责人邮箱', width: 150},
                    {field: 'telephone', title: '负责人电话', width: 150},
                    {field: 'introducation', title: '片区基本情况', width: 300}
                ]],
                toolbar: "#toolbar"//工具栏
            });
            ...
            $("#delete").click(function () {
                ...
                if (selectLength === 0) {
                    ...
                    $.messager.confirm("消息提醒", "删除后将无法恢复该片区信息! 确定继续?", function (r) {
                        if (r) {
                            $.ajax({
                                type: "post",
                                url: "deleteZone?t" + new Date().getTime(),
                                data: {ids: ids},
                                dataType: 'json',
                ...
                buttons: [
                    {
                        ...
                        handler: function () {
                            ...
                            if (!validate) {
                                ...
                                $.ajax({
                                    type: "post",
                                    url: "addZone?t" + new Date().getTime(),
                                    data: data,
                                    dataType: 'json',
                                    success: function (data) {
                                        if (data.success) {
                ...
                buttons: [
                    {
                        ...
                        handler: function () {
                            ...
                            if (!validate) {
                                ...
                                $.ajax({
                                    type: "post",
                                    url: "editZone?t=" + new Date().getTime(),
                                    data: data,
                                    dataType: 'json',
                                    success: function (data) {
                                        if (data.success) {
...
<div id="toolbar">
    ...
    <div style="margin-left: 10px;">
        ...
        <a id="edit" href="javascript:;" class="easyui-linkbutton"
           data-options="iconCls:'icon-grade',plain:true">片区名称</a>
        ...
        <table id="addTable" style="border-collapse:separate; border-spacing:0px 3px;" cellpadding="6">
            <tr>
                ...
                <td colspan="1">
                    <input id="add_name" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="name" data-options="required:true, missingMessage:'请填写片区名称'"/>
                </td>
            </tr>
            <tr>
                <td>片区负责人</td>
                <td colspan="1"><input id="add_manager" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       ...
                                       data-options="required:true, missingMessage:'请填写负责人姓名'"/>
                </td>
            </tr>
            <tr>
                <td>负责人邮箱</td>
            ...
            <tr>
                ...
                <td colspan="4"><input id="add_introduation" style="width: 200px; height: 60px;" class="easyui-textbox"
                                       ...
                                       data-options="multiline:true,required:true, missingMessage:'片区基本情况不能为空'"/>
                </td>
            </tr>
        </table>
    </form>
        ...
        <table id="editTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            <tr>
                ...
                <td><input id="edit_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="name" data-options="required:true, missingMessage:'请填写片区名称'"/>
                </td>
            </tr>
            <tr>
                <td>片区负责人</td>
