...
<head>
    ...
    <script type="text/javascript">
        ...
        var _menus = {
            "menus": [
                {
                    "menuid": "1", "icon": "", "menuname": "公交司机信息管理",
                    "menus": [
                        {
                            "menuid": "21",
                            "menuname": "司机列表",
                            "icon": "icon-driver",
                            "url": "../driver/goDriverListView"
                        }
                    ]
                },
                <%-- 通过JSTL设置用户查看权限--%>
                ...
                {
                    "menuid": "2", "icon": "", "menuname": "线路信息管理",
                    "menus": [
                        {
                            "menuid": "22",
                            "menuname": "线路列表",
                            "icon": "icon-route",
                            "url": "../route/goRouteListView"
                        }
                    ]
                },
                {
                    "menuid": "3", "icon": "", "menuname": "片区信息管理",
                    "menus": [
                        {
                            "menuid": "23",
                            "menuname": "片区列表",
                            "icon": "icon-zone",
                            "url": "../zone/goZoneListView"
                        }
                    ]
                },
                {
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head">
        	<span style="color:blue;" class="easyui-linkbutton" data-options="iconCls:'icon-user',plain:true">
        		...
        		<c:choose>
                    ...
                    <c:when test="${userType==2 }">公交司机 ：</c:when>
                </c:choose>
        	</span>
            <%-- 从Session中获取登录用户的用户名	--%>
    ...
    <span style="padding-left:10px; font-size: 20px; color:darkgrey;font-weight: bold">城市公交管理系统</span>
</div>
